...
const AddressForm: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.locality.trim())
      newErrors.locality = "Locality/Area/Street is required";
    if (!formData.flatBuilding.trim())
      newErrors.flatBuilding = "Flat no/Building name is required";
  ...
  const handleSaveAddress = async () => {
    if (validateForm()) {
      ...
      try {
        ...
        if (from === "Select_address") {
          router.back();
        } else router.push("/Saved-Address");
      } catch (error) {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.addressTypeContainer}>
              {(["Home", "Office", "Site", "Other"] as AddressType[]).map(
                (type) => (
                  <TouchableOpacity
                    key={type}
                    ...
                    <View style={styles.radioContainer}>
                      ...
                      <Text
                        style={[
                          ...
                          formData.addressType === type &&
                            styles.addressTypeSelectedText,
                        ]}
                      >
                        {type}
                      </Text>
